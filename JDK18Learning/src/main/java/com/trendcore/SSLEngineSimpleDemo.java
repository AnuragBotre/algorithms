...
public class SSLEngineSimpleDemo {
    ...
    public SSLEngineSimpleDemo() throws Exception {
        ...
        URL resource = SSLEngineSimpleDemo.class.getClassLoader().getResource(".");
        ...
        ks.load(new FileInputStream(resource.getFile() + keyStoreFile), passphrase);
        ts.load(new FileInputStream(resource.getFile() + trustStoreFile), passphrase);
