...
public class LoggableReadWriteLock
     ...
     */
    public LoggableReadWriteLock(String label,BlockingQueue queue) {
        this(label,false , queue);
    }
     ...
     */
    public LoggableReadWriteLock(String label, boolean fair, BlockingQueue queue) {
        this.label = label;
    ...
    public static class ReadLock implements Lock, java.io.Serializable {
         ...
         */
        protected ReadLock(LoggableReadWriteLock lock) {
            sync = lock.sync;
        }
    ...
    public static class WriteLock implements Lock, java.io.Serializable {
         ...
         * @throws NullPointerException if the lock is null
         */
        protected WriteLock(LoggableReadWriteLock lock) {
            sync = lock.sync;
        }
